/* README - MessagingActivity.java should only be used to implement functionality in the activities it belongs to.
...
public final class MessagingActivity extends AppCompatActivity {
    @Override
